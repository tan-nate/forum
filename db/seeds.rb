...
natedogg = User.create(username: "natedogg", password: "bedope123", clipboard: Clipboard.create)
eddie = User.create(username: "eddie", password: "trumpusa", clipboard: Clipboard.create)
christina = User.create(username: "christina", password: "kombucha", clipboard: Clipboard.create)
