...
border_crisis_quote_against = Quote.create(user: eddie, text: %Q("Remember, immigration – illegal immigration – is at historical lows. There is no crisis at the border [between the U.S. and Mexico]," the former press secretary said. "So, you've got to start from the place that everything the president's saying is fiction."
